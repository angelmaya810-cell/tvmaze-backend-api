...
Paso 1 completado: estructura base del proyecto y prueba de arranque.

Los endpoints y la persistencia se incorporarán de forma incremental en los siguientes pasos de la prueba técnica.
